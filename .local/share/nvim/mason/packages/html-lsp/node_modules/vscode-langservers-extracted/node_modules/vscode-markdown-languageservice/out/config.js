 ...
 */
export var PreferredMdPathExtensionStyle;
...
})(PreferredMdPathExtensionStyle || (PreferredMdPathExtensionStyle = {}));
...
export function getLsConfiguration(overrides) {
...
export function isExcludedPath(configuration, uri) {
